;(function () {
  ...
  var apiHost = apiConfig.host
  var methodPaths = apiConfig.resources
  ...
  // Authenticate a request / get information about an access token
  /**
   * @method tokenInfo
   * @static
   ...
   * @param {object} metadata Annotation object
   * @param {string} access_token Access token
   * @param {function} [fn] Callback function
   * @return {object} Response value
   * @description
  ...
  function annotateTransaction (transaction_id, metadata, access_token, fn) {
    if (typeof transaction_id === 'object') {
      ...
      metadata = _.extend({}, transaction_id.metadata)
   ...
   * @param {date|string} params.since Transactions since (Date object or ISO string)
   * @param {date|string} params.before Transactions before (Date object or ISO string)
   * @param {int} params.limit Number of transactions to return
   * @param {string} access_token Access token
   * @param {function} [fn] Callback function
   * @return {object} Response value
   * @description
   ...
   * @param {string} params.params.title Title
   * @param {string} params.params.image_url Image url
